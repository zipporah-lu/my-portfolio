...
const DigitalDesign = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      ...
      {/* Content Section */}
      <div className="bg-white px-16 py-8 rounded-lg w-full shadow-md -mt-20 max-w-6xl">
        <h1 className="text-5xl font-bold text-gray-900 text-center">Digital Designer</h1>
